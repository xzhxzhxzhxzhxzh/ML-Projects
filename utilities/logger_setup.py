...
def logger_setup(logs_path: 'str' = 'logs') -> None:
    '''Define a logger.'''
    ...
    info_log_path = os.path.join(logs_path, info_log_name)
    warning_log_path = os.path.join(logs_path, warning_log_name)
    error_log_path = os.path.join(logs_path, error_log_name)
